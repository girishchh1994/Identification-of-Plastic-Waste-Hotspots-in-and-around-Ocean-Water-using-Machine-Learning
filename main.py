...
def predict():
    if request.method == 'POST':
        ...
        img.save("~/FlaskApp/tf_files/image.png")
        ...
        #!!!!!!!!!!!!!!!!
        image_data = tf.io.gfile.GFile("~/FlaskApp/tf_files/image.png", 'rb').read()
        label_lines = [line.rstrip() for line
                           in tf.io.gfile.GFile("~/FlaskApp/tf_files/retrained_labels.txt")]

        # Unpersists graph from file
        with tf.io.gfile.GFile("~/FlaskApp/tf_files/retrained_graph.pb", 'rb') as f:
